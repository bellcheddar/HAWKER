#!/usr/bin/env python3
"""
A thin App Store Connect API client, enough for what HAWKER needs.
...
# macOS and visionOS deliberately share com.mdeller.hawker with iOS, so one
# universal app record covers all four of iPhone, iPad, Mac and Vision Pro. A
# separate .mac identifier would split them into two store listings.
BUNDLE_IDS = [
    ("com.mdeller.hawker", "HAWKER", "IOS"),
    ("com.mdeller.hawker.watchkitapp", "HAWKER Watch App", "IOS"),
    ...
    ("com.mdeller.hawker.watchkitapp.widget", "HAWKER Watch Widget", "IOS"),
]
